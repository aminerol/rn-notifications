...
public class RNNotificationsModule extends ReactContextBaseJavaModule implements ActivityEventListener {
   ...
   @ReactMethod
    public void scheduleLocalNotification(ReadableMap notificationPropsMap, int notificationId) {
       if(BuildConfig.DEBUG) Log.d(LOGTAG, "Native method invocation: scheduleLocalNotification");
       final Bundle notificationProps = Arguments.toBundle(notificationPropsMap);
       final IPushNotification pushNotification = PushNotification.get(getReactApplicationContext().getApplicationContext(), notificationProps);
    ...
    @ReactMethod
    public void getScheduledLocalNotifications(final Promise promise) {
        Log.d(LOGTAG, "Native method invocation: getScheduledLocalNotifications");
        IPushNotificationsDrawer notificationsDrawer = PushNotificationsDrawer.get(getReactApplicationContext().getApplicationContext());
        promise.resolve(notificationsDrawer.onGetScheduledLocalNotifications());
    }
